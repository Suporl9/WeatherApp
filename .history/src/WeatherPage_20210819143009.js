        ...
        <div className="middlecard">
          ...
          <div className="details">
            <div className="detailsleft">
              ...
              <p>Temperature : {temperature && temperature.main.temp} 'C</p>
              <p>Humidity : {temperature && temperature.main.humidity}</p>
              <p>Pressure : {temperature && temperature.main.press}</p>
            </div>
            <div className="detailsright">
              <p>Latitude:{temperature && Math.floor(temperature.coord.lat)}</p>
              <p>Longitude:{temperature && temperature.coord.lon}</p>
            </div>
          </div>
        </div>
      </div>
